        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorEmail = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityStatus = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    LeaveStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LeaveEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Skills = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    BackupEmployeeName = table.Column<string>(type: "nvarchar(140)", maxLength: 140, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_AvailabilityStatus",
                table: "Employees",
